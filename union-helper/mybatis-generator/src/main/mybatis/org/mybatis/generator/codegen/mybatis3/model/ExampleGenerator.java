...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    private InnerClass getGeneratedCriteriaInnerClass(
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable
            ...
            if (introspectedColumn.isJdbcCharacterColumn()) {
                ...
                answer.addMethod(getSetLikeMethodAutoFix(introspectedColumn));
                answer.addMethod(getSetNotLikeMethodAutoFix(introspectedColumn));
            }
    ...
    private Method getSetLikeMethodAutoFix(IntrospectedColumn introspectedColumn)
    {
        return getSingleValueMethodAutoFix(introspectedColumn, "LikeAF", "like");
    }

    private Method getSetNotLikeMethodAutoFix(IntrospectedColumn introspectedColumn) {
        return getSingleValueMethodAutoFix(introspectedColumn, "NotLikeAF", "not like");
    }

    private Method getSingleValueMethodAutoFix(IntrospectedColumn introspectedColumn, String nameFragment, String operator)
    {
        Method method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        ...
        method.addBodyLine("addCriterion(\"" + MyBatis3FormattingUtilities.getAliasedActualColumnName(introspectedColumn) + " is null\");");
